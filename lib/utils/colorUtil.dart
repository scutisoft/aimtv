...
class ColorUtil {
 /* static Color theme = const Color(0xffF8F8F8);
  ...
  static Color themeBlack = const Color(0xff212121);
  ...
  static TextStyle textStyle18 =
      TextStyle(fontFamily: 'RR', fontSize: 18, color: Color(0xff2C2C2D));
  static TextStyle notiText =
      TextStyle(fontFamily: 'RR', color: Color(0xFFffffff), fontSize: 10);
  ...
  static Color partiallyPaidClr = const Color(0xffF3FF6D);
  static Color payClr = const Color(0xff062778);
  static Color approvedClr = const Color(0xff019342);

  static TextStyle paidTS =
      TextStyle(fontFamily: 'RR', fontSize: 15, color: ColorUtil.secondary);
  static TextStyle pendingTS =
      TextStyle(fontFamily: 'RR', fontSize: 15, color: Color(0xffE4BE49));

  static const TextStyle fseAccRejGridTS = TextStyle(
      fontFamily: 'USB', fontSize: 18, color: ColorUtil.primaryTextColor2);
  static const TextStyle fseAccRejGridBosyTS =
      TextStyle(fontFamily: 'RR', fontSize: 15, color: Color(0xff6E6E6E));

  static TextStyle search2ActiveTS = TextStyle(
      fontFamily: Language.regularFF, fontSize: 15, color: Color(0xffffffff));
  static TextStyle search2InActiveTS = TextStyle(
      fontFamily: Language.regularFF, fontSize: 15, color: Color(0xff979797));
  ...
  static EdgeInsets formMargin = const EdgeInsets.only(
    left: 15,
    right: 15,
    top: 10,
  );
  static Color formTableBorder = primary.withOpacity(0.15);
  static TextStyle formTableBodyTS =
      TextStyle(fontSize: 13, fontFamily: 'RR', color: themeBlack);
  static TextStyle formTableBodyTSB =
      TextStyle(fontSize: 13, fontFamily: 'Bold', color: themeBlack);
  static TextStyle formTableHeaderTS =
      TextStyle(fontSize: 12, fontFamily: 'Med', color: ColorUtil.themeBlack);*/
  ...
  // static Color themeBlack = const Color(0xff212121);
  // static Color secondary = const Color(0xff476039);
  // static Color primary = const Color(0xffFCB134);
  // static Color greyBorder = const Color(0xff808080);
  // static Color greyFill = const Color(0xff656565);
  // static Color greyLite = const Color(0xffF5F6FA);
  // static Color text1 = const Color(0xff4C4C4C);
  // static Color text2 = const Color(0xff452800);
  // static Color text3 = const Color(0xff828282);
  // static Color text4 = const Color(0xffA6A6A6);
  // static Color lightgrey = const Color(0xffF2F2F2);
...
//Anandham
//   static Color theme = const Color(0xffF5F5F5);
//   static Color themeWhite = const Color(0xffffffff);
//   static Color themeBlack = const Color(0xff212121);
//   static Color secondary = const Color(0xff476039);
//   static Color primary = const Color(0xffEF3672);
//   static Color primarylite = const Color(0xffFEF1F5);
//   static Color primary2 = const Color(0xffFF7A99);
//   static Color greyBorder = const Color(0xff808080);
//   static Color greyFill = const Color(0xff656565);
//   static Color greyLite = const Color(0xffF5F6FA);
//   static Color text1 = const Color(0xff4C4C4C);
//   static Color text2 = const Color(0xff452800);
//   static Color text3 = const Color(0xff828282);
//   static Color text4 = const Color(0xff838383);
//   static Color lightgrey = const Color(0xffF2F2F2);
//   static Color text5 = const Color(0xff6E6E6E);
//   static Color lightBlue = const Color(0xffF4F7FC);
//   static Color red = const Color(0xffE1433A);
...
//Kiosk
static Color theme = const Color(0xffFAFAFA);
static Color themeWhite = const Color(0xffffffff);
static Color themeBlack = const Color(0xff212121);
static Color secondary = const Color(0xff476039);
static Color primary = const Color(0xffF30021);
static Color primarylite = const Color(0xffFEF1F5);
static Color primary2 = const Color(0xffFF7A99);
static Color greyBorder = const Color(0xff808080);
static Color greyFill = const Color(0xff656565);
