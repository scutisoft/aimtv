...
class AnandhamSplashScreen extends StatefulWidget {
  const AnandhamSplashScreen({Key? key}) : super(key: key);
  @override
  _AnandhamSplashScreenState createState() => _AnandhamSplashScreenState();
}

class _AnandhamSplashScreenState extends State<AnandhamSplashScreen> {
      ...
      child: Stack(
        children: [
          Container(
            ...
            child: Image.asset('assets/anandham/splash.png')
