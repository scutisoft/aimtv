                ...
                child: Column(
                  ...
                  children: [
                   /* CustomAppBar(
                    ...
                    SvgPicture.asset("assets/login/pinBg.svg",height: SizeConfig.screenHeight!-500,),
                    Visibility(
                        visible: !hasPin,
                        child: Container(
                          ...
                          children: [
                            ...
                            DoneBtn(onDone: (){
                              insertDeviceInfo("");
                              navigateByUserType();
                            }, title: Language.skip,bg: Colors.transparent,tc: ColorUtil.themeBlack,),
                            LoginBtn(
                                ontap: (){
                                  if(pinWidget.validate() && confirmPinWidget.validate()){
                                    if(pinWidget.getValue()!=confirmPinWidget.getValue()){
                            ...
                            const SizedBox(height: 30,),
                            Obx(() => Visibility(visible:isKeyboardVisible.value,child: SizedBox(height: 100,)))
                          ],
                      ),
                        )
                    )
