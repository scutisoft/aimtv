import 'dart:convert';
import 'dart:io';
import 'package:aimtv/maOrganicsPages/maOrganicsWebView.dart';
...
class MaOrganicsSplashScreen extends StatefulWidget {
  const MaOrganicsSplashScreen({Key? key}) : super(key: key);
  @override
  _MaOrganicsSplashScreenState createState() => _MaOrganicsSplashScreenState();
}

class _MaOrganicsSplashScreenState extends State<MaOrganicsSplashScreen> {
  final LocalAuthentication auth = LocalAuthentication();

  navigate() {
    //Get.off(KaylirWebView());
    Get.off(MaOrganicsWebView());
  }
      ...
      child: Stack(
        children: [
          Container(
            ...
            color: Colors.white,
              child: Image.asset('assets/maorganics/maorganics.png')
